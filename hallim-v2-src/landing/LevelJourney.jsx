 ...
 return <div className={s.outer}>
  ...
  <div className={s.panel} aria-label="Interactive illustration of Hallim learning routes">
   ...
   <div className={s.canvas}>
    <div className={s.selectorTop}><span>Choose a chapter to explore</span><span className={s.selectorHint}>TAP TO SWITCH ↘</span></div>
   ...
   <div className={s.route}><div className={s.routeTitle}><span>YOUR ROUTE, YOUR PACE</span><span aria-hidden="true">✳</span></div><div className={s.routeTrack}><span className={level==="starter"?s.routeCurrent:s.routePast}>Starter</span><span className={s.routeArrow}>→</span><span>Foundation</span><span className={s.routeArrow}>→</span><span className={level==="elementary"?s.routeCurrent:""}>Elementary</span></div><p>Explore sample lessons here. Your actual learning progress begins when you sign in.</p></div>
  </div>
